                                    ...
                                    <div class="product-item">
                                        <figure class="product-thumb">
                                            ...
                                            <div class="button-group">
                                                <a href="javascript:void(0)" onclick='addWishlist(${product.pro_id})' data-toggle="tooltip" data-placement="left" title="添加收藏"><i class="lnr lnr-heart"></i></a>
                                                <a href="javascript:void(0)" onclick='getProduct(${product.pro_id})' data-toggle="modal" data-target="#quick_view"><span data-toggle="tooltip" data-placement="left" title="快速预览"><i class="lnr lnr-magnifier"></i></span></a>
