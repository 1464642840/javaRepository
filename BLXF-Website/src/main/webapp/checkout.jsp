            ...
            <div class="row">
                ...
                <div class="col-lg-11">
                    <div class="checkout-billing-details-wrap">
                        <h2>收件信息</h2>
                        <s:iterator value="#request.address" var="item" status="status">

                            <div class="addre fl ">


                                <input type='hidden' name='addresss_id' id='addresss_id'
                                       value="${item.user_addr_id}"/>
